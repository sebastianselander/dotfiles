...
_G.packer_plugins = {
  ...
  ["diffview.nvim"] = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/diffview.nvim",
  ...
  ["eyeliner.nvim"] = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/eyeliner.nvim",
  ...
  ["landscape.vim"] = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/landscape.vim",
  ...
  nvimgelion = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/nvimgelion",
    url = "https://github.com/nyngwang/nvimgelion"
  },
  ["oil.nvim"] = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/oil.nvim",
  ...
  ["oxocarbon.nvim"] = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/oxocarbon.nvim",
  ...
  ["papercolor-theme"] = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/papercolor-theme",
  ...
  ["toggleterm.nvim"] = {
    ...
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  vim = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/vim",
  ...
  vimtex = {
    loaded = true,
    path = "/home/sebastian/.local/share/nvim/site/pack/packer/start/vimtex",
